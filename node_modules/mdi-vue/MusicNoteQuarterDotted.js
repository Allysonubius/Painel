...
var script = {
  ...
  props: {
    ...
    ariaLabel: {
      type: String,
      default: 'MusicNoteQuarterDotted icon'
    },
    role: {
      type: String,
      default: 'img'
      ...
      _c(
        ...
        [
          ...
          _c("path", {
            attrs: {
              d:
                "M12 13V13.56A3.96 3.96 0 0 0 10 13A4 4 0 1 0 14 17V3H12M16.5 17A1.5 1.5 0 1 1 15 18.5A1.5 1.5 0 0 1 16.5 17Z"
            }
          })
        ]
      )
