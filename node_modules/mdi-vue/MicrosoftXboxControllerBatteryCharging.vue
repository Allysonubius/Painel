<template functional>
  <span
    :class="[data.staticClass, 'mdi', 'mdi-microsoft-xbox-controller-battery-charging', props.spin ? 'mdi-spin' : undefined]"
    :role="props.role"
...
export default {
  ...
  props: {
    ...
    ariaLabel: {
      type: String,
      default: 'MicrosoftXboxControllerBatteryCharging icon'
    },
    role: {
      type: String,
      default: 'img'
