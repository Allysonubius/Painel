<template functional>
  <span
    :class="[data.staticClass, 'mdi', 'mdi-printer-3-d-nozzle-alert', props.spin ? 'mdi-spin' : undefined]"
    :role="props.role"
...
<script>
export default {
  name: 'mdi-printer-3-d-nozzle-alert',
  props: {
    width: {
      type: [Number, String],
      default: null
    ...
    ariaLabel: {
      type: String,
      default: 'Printer3dNozzleAlert icon'
    },
    role: {
      type: String,
      default: 'img'
