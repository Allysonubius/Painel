<template functional>
  <span
    :class="[data.staticClass, 'mdi', 'mdi-microsoft-xbox-controller-battery-medium', props.spin ? 'mdi-spin' : undefined]"
    :role="props.role"
...
export default {
  ...
  props: {
    ...
    ariaLabel: {
      type: String,
      default: 'MicrosoftXboxControllerBatteryMedium icon'
    },
    role: {
      type: String,
      default: 'img'
