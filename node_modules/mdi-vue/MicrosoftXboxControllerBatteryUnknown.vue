<template functional>
  <span
    :class="[data.staticClass, 'mdi', 'mdi-microsoft-xbox-controller-battery-unknown', props.spin ? 'mdi-spin' : undefined]"
    :role="props.role"
...
export default {
  ...
  props: {
    ...
    ariaLabel: {
      type: String,
      default: 'MicrosoftXboxControllerBatteryUnknown icon'
    },
    role: {
      type: String,
      default: 'img'
